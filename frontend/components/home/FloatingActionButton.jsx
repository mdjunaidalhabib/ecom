  ...
  return (
    <div className="fixed bottom-24 right-4 flex flex-col items-center space-y-3 z-[9999]">
      ...
      <button
        ...
        className={`bg-orange-600 text-white p-3 rounded-full shadow-xl hover:bg-orange-700 
      ...
      >
        <span
          className={`absolute w-12 h-12 rounded-full bg-orange-500/40 animate-ping 
            ${open ? "hidden" : "block"}`}
        />
        <div
