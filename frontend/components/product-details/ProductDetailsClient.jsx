...
export default function ProductDetailsClient({
  ...
  return (
    <main className="container mx-auto px-4 sm:px-6 lg:px-8 mt-4 md:py-8">
      ...
      <section className="bg-orange-50 rounded-2xl grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-6 overflow-hidden">
        <ProductGallery
          images={images}
          activeIdx={activeIdx}
        ...
        <div className="flex flex-col md:px-6 md:py-6 bg-orange-50 gap-4">
          <ProductInfo
            product={product}
            category={category}
            isOutOfStock={isOutOfStock}
