  ...
  return (
    <div className="bg-orange-50">
      <div className="container mx-auto flex flex-col md:flex-row gap-6 p-3 md:p-6">
        {/* === Category Sidebar === */}
        <div className="md:w-64 bg-orange-100 shadow-md rounded-xl p-3 md:p-4">
          ...
          <ul className="flex md:flex-col gap-3 overflow-x-auto md:space-y-2 no-scrollbar">
            {categories.map((cat) => (
              <li
                ...
                className={`flex items-center gap-3 p-2 rounded-lg border border-orange-400 cursor-pointer transition min-w-[120px] md:min-w-0 ${
                  selectedCategory === cat._id
                    ? "bg-orange-300 text-orange-600 font-medium border"
                    : "hover:orange-pink-300"
                }`}
              >
