  ...
  if (wishlistProducts.length === 0) {
    return (
      <div className="bg-orange-50 py-6 ">
        <div className="bg-orange-100 rounded-xl shadow p-6 text-center mx-3 sm:mx-auto sm:w-96">
    ...
    <div className="bg-orange-50">
      <div className="container mx-auto p-3 md:p-6">
        <div className="text-xl sm:text-2xl font-semibold text-center relative inline-block w-full mb-8">
          <span className="bg-gradient-to-r p-4 from-orange-500 via-purple-500 to-blue-600 text-transparent bg-clip-text">
            ❤️ আপনার উইশলিস্ট
          </span>
        </div>
