...
const CartItem = memo(
  ({
    ...
    return (
      <div className="bg-orange-100 rounded-md shadow-sm p-2 flex items-center gap-2 hover:shadow transition-all duration-300">
        {/* ✅ Select Checkbox */}
        <input
          type="checkbox"
          checked={selected}
  ...
  return (
    <main className="bg-orange-50">
      <div className="container mx-auto px-3 sm:px-6 py-5">
        {/* ✅ Header */}
        <div className="mb-2">
          <h2 className="text-center text-lg sm:text-xl font-semibold bg-gradient-to-r from-orange-500 via-purple-500 to-blue-600 text-transparent bg-clip-text mb-2">
            🛒 আপনার কার্ট
          </h2>
        ...
        {loading ? (
          ...
          <div className="bg-orange-100 rounded-xl shadow p-6 text-center">
